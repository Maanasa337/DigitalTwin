...
.PHONY: up down seed logs test test-api test-sim test-contracts test-xai test-nlu test-pdm test-web lint
...
test: test-contracts test-nlu test-pdm test-xai test-sim test-api test-web
